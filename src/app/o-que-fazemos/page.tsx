      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16 max-w-3xl mx-auto animate-in slide-in-from-bottom-8 duration-700 fade-in">
          ...
          <p className="text-lg text-slate-600">
            Trabalhamos de forma integrada para promover a recuperação, acolhimento e reinserção social de jovens e adultos, unindo tratamento especializado e compromisso comunitário.
          </p>
        </div>
